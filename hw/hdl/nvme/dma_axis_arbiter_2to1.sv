/**
 * DMA + AXI4S 2-to-1 Arbiter
 * 
 * Arbitrates between two DMA request sources (each with associated AXI4S data).
 * Used to merge Host DMA and NVMe doorbell DMA onto single XDMA channel.
 */
...
`ifdef EN_ILA_DMA_ARBITER_2TO1
    ...
    ila_dma_arbiter inst_ila_dma_arbiter (
        ...
        // ========== OUTPUT BLOCKED (probe 12-15) - TRIGGER! ==========
