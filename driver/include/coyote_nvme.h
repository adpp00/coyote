 ...
 *
 * Standalone subsystem (parallel to the vfpga_* family) — almost no vfpga_dev
 * coupling internally; only the three vfpga_nvme_* ioctl entry points take a
 * vfpga_dev to bind a device to a region.
 *
