# ILA for TCP->NVMe Store (ila_nvme_tcp_store) - 26 probes
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_nvme_tcp_store
